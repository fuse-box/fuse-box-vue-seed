...
const none_single_file_1 = require("./components/none-single-file");
Vue.component('my-component', none_single_file_1.default);
new Vue({
    el: '#app',
    render: h => h(App),
});
...
___scope___.file("style/main.scss", function(exports, require, module, __filename, __dirname){


require("~/app.css")
});
___scope___.file("components/App.vue", function(exports, require, module, __filename, __dirname){
...
_p.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"fb-app"},[_c('div',{staticClass:"fb-app-content"},[_vm._m(0),_vm._v(" "),_c('h1',{staticClass:"fb-app-title title"},[_vm._v(_vm._s(_vm.msg))]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.msg),expression:"msg"}],staticClass:"fb-app-input input",attrs:{"type":"text"},domProps:{"value":(_vm.msg)},on:{"input":function($event){if($event.target.composing){ return; }_vm.msg=$event.target.value}}}),_vm._v(" "),_c('my-component',{staticClass:"none-single-file"})],1)])}
_p.staticRenderFns = [ function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"fb-app-logos-container"},[_c('img',{staticClass:"fb-app-logo is-fusebox",attrs:{"src":"./assets/fusebox-logo.png"}}),_vm._v(" "),_c('img',{staticClass:"fb-app-heart",attrs:{"src":"./assets/heart.png"}}),_vm._v(" "),_c('img',{staticClass:"fb-app-logo",attrs:{"src":"./assets/vue-logo.png"}})])} ];
var _e = {}; _v(_e); _p = Object.assign(_e.default, _p)
module.exports =_p
                
});
___scope___.file("components/none-single-file/index.js", function(exports, require, module, __filename, __dirname){
...
___scope___.file("components/none-single-file/index.html", function(exports, require, module, __filename, __dirname){

module.exports =  "<div>\r\n    <h1 class=\"fb-app-title title\">This component is a none single file component(no Vue pre-compilation)</h1>\r\n    <h2>{{ msg }}</h2>\r\n    <input type=\"text\" class=\"fb-app-input input\" v-model=\"msg\"/>\r\n</div>"
});
...
___scope___.file("dist/vue.common.js", function(exports, require, module, __filename, __dirname){
